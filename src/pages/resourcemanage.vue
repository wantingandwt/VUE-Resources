		  ...
		  <div class="all-content">
			<span class="layui-breadcrumb search-breadcrumb" lay-separator=">" style="visibility: visible;">
			  ...
			  <ul class="material-ul">
				  <li>
					  <span class="material-span">资源类别：</span>
					  <span class="search-this"><a>全部资源</a></span>
					  <span><a>教学课件</a></span>
					  <span><a>教学视频</a></span>
					  <span><a>其他资源</a></span>
				  </li>
        ...
        :visible.sync="dialogFormVisible" >
          <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="资源类别">
              <el-select v-model="form.type" placeholder="请选择资源类别">
                <el-option label="教学课件" value="教学课件"></el-option>
...
export default {
  ...
  methods: {
   ...
   uploadImg(item) {
    ...
    handleEye(index,row){
      console.log(row);
      this.$router.push({path:'/resourceDetails/'+row.id,
        query:{
           resourceid : this.id
        }
		 })
