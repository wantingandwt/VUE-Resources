	  ...
	  <div class="search">
		  <div class="all-content">
			<span class="layui-breadcrumb search-breadcrumb" lay-separator=">" style="visibility: visible;">
				  ...
				  <a>实训任务</a><span lay-separator="">&gt;</span>
				  <a>任务管理</a>
			</span>
			  <ul class="material-ul">
				  <li>
					  <span class="material-span">任务类别：</span>
      ...
      <div class="manage-table">
        <el-table
          ...
          <el-table-column
            ...
            label="完成情况">
            <template slot-scope="scope">             
              <span style="margin-left: 10px">{{ scope.row.textnunm }}/50</span>
            </template>
          </el-table-column>
          <el-table-column
            label="操作"
        ...
        :visible.sync="dialogFormVisible" >
          <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="任务类别">
              <el-select v-model="form.type" placeholder="请选择任务类别">
                <el-option label="课程实训" value="课程实训"></el-option>
                <el-option label="项目实训" value="项目实训"></el-option>
                 <el-option label="仿真实训" value="仿真实训"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="所属课程">
              <el-select v-model="form.class" placeholder="请选择课程">
                <el-option label="实训课程一" value="实训课程一"></el-option>
                <el-option label="实训课程二" value="实训课程二"></el-option>
                 <el-option label="实训课程三" value="实训课程三"></el-option>
              </el-select>
            </el-form-item>
  ...
  methods: {
   ...
   uploadImg(item) {
    ...
    handleCurrentChange: function (currentPage) {
      ...
      this.$api.get('/task/data','')//点击分页是重新请求改页面的数据
        .then(res => {
          //console.log(res.data);
    ...
    handleEye(index,row){
      console.log(row);
      this.$router.push({path:'/taskDetails/'+row.id,
        query:{
           taskid : this.id
        }
		 })
